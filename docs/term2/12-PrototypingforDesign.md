...
After, I imported the .obj file into Rhino and edited it to make it watertight. I was able to print it in PLA and at first the material was not sticking well to the print bed. So we updated the settings to be from low to standard and increased the temperature to 215 degrees. Next, I would like to scan a piece that has more holes and bigger textures to see how it can capture them in the 3D scan and print. 
